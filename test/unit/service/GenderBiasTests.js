var axios = require('axios');
 ...
 const genderBiasService = require('../../../app/interface');
 const bias = {
 ...
 describe('interface', function () {
     describe('getGenderBias', function () {
       it('should return the gender bias from response', async () => {
         ...
         var results = await genderBiasService.getCapbilities();
       ...
       it('should throw exception when 500 error returned from axios', async () => {
         ...
         expect(error.message).to.equal('Could not return the gender bias. Please try again.')
       })
     })
})