...
describe('UI Testing for category associated with training via bandID', () => {
  it('Should display a table with data containing a category column with its respectable data given the bandID', async() => {
       ...
       expect(await driver.findElement(By.id('CategoryID-2022-11-17')).getText()).to.equal('Professional skills');
