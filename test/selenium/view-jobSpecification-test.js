...
describe('UI Testing for Job Specification Webpage', () => {
  it('Should display the title from job roles webpage', async () => {
    ...
    expect(await driver.findElement(
      By.id('jobSpecificationTitle')).getText()).to.equal('Job Specification')
  ...
  it('Should display the name of the role', async () => {
    ...
    expect(await driver.findElement(By.id('jobRoleName')).getText()).to.equal(
      'Data Analyst')
  ...
  it('Should display the specification for that role', async () => {
    ...
    expect(await driver.findElement(By.id('specTextId')).getText()).to.equal(
      specificationTxt)
