...
describe('UI Testing for the gender prediction page', () => {
  it('Should allow user to enter in a bias text in the provided text box',
    async () => {
      ...
      await driver.findElement(By.id('gender-bias-textbox')).sendKeys(
        'He saw her')
      ...
      expect(await driver.findElement(By.id('biased%Text')).getText()).to.equal(
        '50.0%')
  ...
  it('Should allow user to enter in a un-bias text in the provided text box',
    async () => {
      var driver = new webdriver.Builder()
        .withCapabilities(webdriver.Capabilities.chrome())
        .build()
      ...
      // Go into the text box and enter in a bias snippet of text
      await driver.findElement(By.id('gender-bias-textbox')).sendKeys(
        'They love shopping in the city centre')
      // Click submit to send the following text to the model and receive the results back from the API
      await driver.findElement(By.id('submit')).click()
      // Compare actual bias predicted from expected
      expect(await driver.findElement(By.id('biased%Text')).getText()).to.equal(
  ...
  it('Should show user all the male bias test found in the text box',
    async () => {
      var driver = new webdriver.Builder()
        .withCapabilities(webdriver.Capabilities.chrome())
        .build()
      ...
      expect(
        await driver.findElement(By.id('maleBiasedText')).getText()).to.equal(
        'he')
      expect(
        await driver.findElement(By.id('femaleBiasedText')).getText()).to.equal(
        'her')
  ...
  it('Should be able to go back onto the homepage via back button',
    async () => {
      var driver = new webdriver.Builder()
        .withCapabilities(webdriver.Capabilities.chrome())
        .build()
