...
<html lang="{{ htmlLang | default('en') }}" class="govuk-template {{ htmlClasses }}">
  <head>
    ...
    {% block headIcons %}
      <link rel="shortcut icon" sizes="16x16 32x32 48x48" href="{{ assetPath | default('/assets') }}/images/favicon2.ico" type="image/x-icon">
      <link rel="icon" href="{{ assetPath | default('/assets') }}/images/favicon2.ico" />
      <link rel="mask-icon" href="{{ assetPath | default('/assets') }}/images/Kainos.svg" color="{{ themeColor | default('#001E60') }}">
      <link rel="apple-touch-icon" sizes="180x180" href="{{ assetPath | default('/assets') }}/images/apple180.png">
       <link rel="apple-touch-icon" sizes="167x167" href="{{ assetPath | default('/assets') }}/images/apple167.png">
        <link rel="apple-touch-icon" sizes="152x152" href="{{ assetPath | default('/assets') }}/images/apple152.png">
      <link rel="apple-touch-icon" href="{{ assetPath | default('/assets') }}/images/apple120.png">
    {% endblock %}
